...
class OpenAIClient {
    ...
    fun ask(userText: String, scene: String, onAnswer: (String) -> Unit) {
        ...
        // Здесь можно добавить логику для формирования ответа на основе userText и scene
        val answer = "Ваш запрос: \"$userText\". Сцена: \"$scene\". Пожалуйста, уточните, что именно вас интересует."
